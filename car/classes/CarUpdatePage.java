...
public class CarUpdatePage implements ActionListener {
 ...
 ImageIcon image=new ImageIcon("images\\carupdate.png");
    ...
    JFrame frame = new JFrame("RENTED CAR PAGE");
 
    JLabel text1 = new JLabel("       YOUR RENTED CAR   ");
    ...
    public CarUpdatePage(String CarRegNumber,String Id) {
        ...
        ModelTextField.setBorder(BorderFactory.createMatteBorder(01, 01, 1, 01, Color.black));
        ...
        LicenseNumberTextField.setBorder(BorderFactory.createMatteBorder(01, 01, 1, 01, Color.black));
        ...
        colorTextField.setBorder(BorderFactory.createMatteBorder(01, 01, 1, 01, Color.black));
        ...
        BackButton.setBounds(50, 0, 80, 60);
