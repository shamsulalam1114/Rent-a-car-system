...
public class CarRentalPage implements ActionListener {
    JFrame frame = new JFrame("ADD CAR FOR RENT PAGE");

     ImageIcon image=new ImageIcon("images\\carupdate.png");
    JLabel label=new JLabel();
    JLabel imageLabel=new JLabel(image);
 
    JLabel text1 = new JLabel("         CAR DETAILS ");
    ...
    public CarRentalPage(String CarRegNumber,String Id) {
        ...
        OwnerNameLabel.setBackground(Color.black);
        ...
        ModelTextField.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black));
        ...
        NumberTextField.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black));
        ...
        LicenseNumberTextField.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black));
        ...
        colorTextField.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black));
        ...
        locationTextField.setBounds(300,350,350,30);
        locationTextField.setBackground(Color.white);
        locationTextField.setOpaque(true);
        locationTextField.setEditable(false);
 locationTextField.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black));


        rateTextField.setBounds(300, 400, 350, 30);
        rateTextField.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black));
        ...
        TypeTextField.setBounds(300,450,350,30);
        TypeTextField.setBackground(Color.white);
        TypeTextField.setOpaque(true);
        TypeTextField.setEditable(false);
 TypeTextField.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black));
 
        OwnerNameTextField.setBounds(300,500,350,30);
        OwnerNameTextField.setBackground(Color.white);
        OwnerNameTextField.setOpaque(true);
        OwnerNameTextField.setEditable(false);
OwnerNameTextField.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black));

 
        StatusTextField.setBounds(300,550,350,30);
        StatusTextField.setBackground(Color.white);
         StatusTextField.setOpaque(true);
        StatusTextField.setEditable(false);
 StatusTextField.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black));

        RentedByTextField.setBounds(300,600,350,30);
        RentedByTextField.setBackground(Color.white);
        RentedByTextField.setOpaque(true);
        RentedByTextField.setEditable(false);
 RentedByTextField.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black));
        ...
        BackButton.setBounds(50, 0, 80, 30);
       ...
       if (e.getSource() == BackButton) {
        ...
        if (e.getSource() ==RentButton) {
            if(Status.equals("Not Available")){
                JOptionPane.showMessageDialog(null,"Car Not Available" , "Message",JOptionPane.OK_CANCEL_OPTION );
            }
            else{
            frame.dispose();
           new CarPayment(CarRegNumber,UserID,CarRent);
            }
